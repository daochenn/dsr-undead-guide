...
export interface NpcDialogue {
  npcName_en: string;
  npcName_zh: string;
  dialogue_en: string;      // 简化版对话（预览用）
  dialogue_zh: string;      // 简化版对话（预览用）
  fullDialogue_en?: string; // 完整版对话（可选）
  fullDialogue_zh?: string; // 完整版对话（可选）
  location_en: string;
  location_zh: string;
}
    ...
    npcDialogues: [
      {
        ...
        dialogue_zh: '唷！你来得正好，已经好久没见到新来的啦。我想你八成是为了那些事而来的吧？不死人的使命之类的……大家都一样。遭受诅咒的时候一切就都完啦，一直待在不死院才是比较明智的抉择……你苦啦。不过也无所谓啦，反正我闲着也是闲着，就教教你吧。在不死人的使命中提到的苏醒之钟总共有两口，其中一口就放在此地上方，不死教堂的钟楼，而另一口则是放在此地下方深处，病村底下的古代遗迹中。据说只要敲响这两口钟，就会发生某些事，不过……谁知道会怎样呢？至少就我而言，是从没听说过后来怎样啦……反正也没差。快上路吧，你来到这个受诅咒的不死人之地，不就是为这件事吗？……呵呵呵呵呵',
        fullDialogue_zh: '唷！你来得正好，已经好久没见到新来的啦。我想你八成是为了那些事而来的吧？不死人的使命之类的……大家都一样。遭受诅咒的时候一切就都完啦，一直待在不死院才是比较明智的抉择……你苦啦。不过也无所谓啦，反正我闲着也是闲着，就教教你吧。在不死人的使命中提到的苏醒之钟总共有两口，其中一口就放在此地上方，不死教堂的钟楼，而另一口则是放在此地下方深处，病村底下的古代遗迹中。据说只要敲响这两口钟，就会发生某些事，不过……谁知道会怎样呢？至少就我而言，是从没听说过后来怎样啦……反正也没差。快上路吧，你来到这个受诅咒的不死人之地，不就是为这件事吗？……呵呵呵呵呵',
        location_en: 'Firelink Shrine',
        location_zh: '传火祭祀场',
      },
      {
        ...
        fullDialogue_zh: '虽说其中一口钟确实放在此地上方的不死教堂，但现在升降梯已经不动了。所以说，你只能沿着旁边的山崖往上爬，从水路进入不死镇。另一口钟，就从那座不死镇往下走就可以了。……但话说回来，不死镇下去可是座聚集了许多病患的病村。如果是我的话，可是会希望离那地方远远的呢。',
        location_en: 'Firelink Shrine',
        location_zh: '传火祭祀场',
      },
      {
        ...
        fullDialogue_zh: '你已经去过这下面的小隆德遗迹了吗？只要从这边的楼梯往下走，再搭乘升降梯，就可以立刻抵达了。如果还没去过的话，最好去一下看看。那是座古老的不死人遗迹，说不定藏着什么关于使命的提示呢。举例来说，像是亡灵的欢迎之类的……哼哼哼哼',
        location_en: 'Firelink Shrine',
        location_zh: '传火祭祀场',
      },
      {
        ...
        fullDialogue_zh: '说到这边，你为什么不冶炼武器呢？如果你不知道安德烈老爹的话，不妨从不死教堂往下走，到森林的古老教堂走一趟。最好还是早点去找他。……但话说回来，如果你就是喜欢用钝钝的武器，那就随你高兴啦！',
        location_en: 'Firelink Shrine',
        location_zh: '传火祭祀场',
      },
      {
        ...
        dialogue_zh: '说到这边，你应该也见过了吧？……那系火女呀。她的职责似乎就是一直待在那边，避免不死营火熄灭。唉，真是够惨的了。话也没办法说，哪儿都去不了。我猜那女的，她故乡的人一定是拔了她的舌头，让她喊不出神的名字。所谓的虔诚善人，还真是了不起呀。我绝对办不到的，真是佩服！',
        fullDialogue_zh: '说到这边，你应该也见过了吧？……那系火女呀。她的职责似乎就是一直待在那边，避免不死营火熄灭。唉，真是够惨的了。话也没办法说，哪儿都去不了。我猜那女的，她故乡的人一定是拔了她的舌头，让她喊不出神的名字。所谓的虔诚善人，还真是了不起呀。我绝对办不到的，真是佩服！',
        location_en: 'Firelink Shrine',
        location_zh: '传火祭祀场',
      },
      {
        ...
        dialogue_zh: '……你那张脸简直就和游魂没两样嘛。大概是因为死得太过头了，不过照这样下去，可是马上就会变成真的游魂喔。得要赶紧取得人性呀。……不过话说回来，说不定成为游魂反而比较轻松呢。……呵呵呵呵呵……嗯？怎么啦？怎样收集人性？虽说要怎么做还是看你的决定啦……看是要踏实地捡尸体收集……或是和那票圣职一样，狼狈为奸地相互召唤彼此……另外，虽然我自己是办不到啦，不过最快的方法，就是杀害正常的不死人来夺取人性。杀人来夺取，说不定反而是最贴近人性的做法呢…………呵呵呵呵呵……虽然这样讲，但你可别对我下手呀。把事情想得太简单，日后可是会后悔的……',
        fullDialogue_zh: '……你那张脸简直就和游魂没两样嘛。大概是因为死得太过头了，不过照这样下去，可是马上就会变成真的游魂喔。得要赶紧取得人性呀。……不过话说回来，说不定成为游魂反而比较轻松呢。……呵呵呵呵呵……嗯？怎么啦？怎样收集人性？虽说要怎么做还是看你的决定啦……看是要踏实地捡尸体收集……或是和那票圣职一样，狼狈为奸地相互召唤彼此……另外，虽然我自己是办不到啦，不过最快的方法，就是杀害正常的不死人来夺取人性。杀人来夺取，说不定反而是最贴近人性的做法呢…………呵呵呵呵呵……虽然这样讲，但你可别对我下手呀。把事情想得太简单，日后可是会后悔的……',
        location_en: 'Firelink Shrine',
        location_zh: '传火祭祀场',
      },
      {
        ...
        dialogue_zh: '喂！难不成……你遭到诅咒了？这还真是不死人中的不死人啊，节哀顺变啦。……虽然这样讲，但你可别对我下手呀。把事情想得太简单，日后可是会后悔的…………哇哈哈哈哈哈……啊，抱歉、抱歉。就让我教你一件事来致歉吧。虽然那是很久前的事了……但我曾听说小隆德有一位解咒师。反正就算没找到也不过是和现在一样而已，去走一遭也没差吧？不过，即便是真的没找到也别怨我呀！',
        fullDialogue_zh: '喂！难不成……你遭到诅咒了？这还真是不死人中的不死人啊，节哀顺变啦。……虽然这样讲，但你可别对我下手呀。把事情想得太简单，日后可是会后悔的…………哇哈哈哈哈哈……啊，抱歉、抱歉。就让我教你一件事来致歉吧。虽然那是很久前的事了……但我曾听说小隆德有一位解咒师。反正就算没找到也不过是和现在一样而已，去走一遭也没差吧？不过，即便是真的没找到也别怨我呀！',
        location_en: 'Firelink Shrine',
        location_zh: '传火祭祀场',
      },
      {
        ...
        dialogue_zh: '也是啦，毕竟您都开口了，我就告诉您吧。对圣职而言，不死人的使命主要便是探索"注火，""注火"就是借由人性，让不死营火烧得更旺的技艺。这样会让我们获得英雄的能力。',
        fullDialogue_zh: '也是啦，毕竟您都开口了，我就告诉您吧。对圣职而言，不死人的使命主要便是探索"注火，""注火"就是借由人性，让不死营火烧得更旺的技艺。这样会让我们获得英雄的能力。',
        location_en: 'Firelink Shrine',
        location_zh: '传火祭祀场',
      },
      {
        ...
        dialogue_zh: '喔，你人还好吧？嗯，我也好不容易安全了。我会使用大沼的咒术，小心一点就还过得去。啊，对了，我可以教你咒术，你想学吗？你有天赋，所以只要有材料就可以办得到。算是我答谢你的一点心意啦。……还是你也想说，你觉得咒术很恶心？',
        fullDialogue_zh: '喔，你人还好吧？嗯，我也好不容易安全了。我会使用大沼的咒术，小心一点就还过得去。啊，对了，我可以教你咒术，你想学吗？你有天赋，所以只要有材料就可以办得到。算是我答谢你的一点心意啦。……还是你也想说，你觉得咒术很恶心？',
        location_en: 'Firelink Shrine',
        location_zh: '传火祭祀场',
      },
      {
        ...
        npcName_zh: '德纳尔',
        dialogue_en: "Hmm... well, since you're a good customer, I'll tell you. If you want the 'Rite of Kindling' from the Catacombs, you'll need a Divine weapon. That should subdue the reanimated skeletons.",
        dialogue_zh: '嗯……算了，看在和你应该会有笔不错的交易份上……我就告诉你吧。如果想要地下墓地里的"注火，"就要用神圣武器。这应该可以制服苏醒的骸骨。',
        fullDialogue_zh: '嗯……算了，看在和你应该会有笔不错的交易份上……我就告诉你吧。如果想要地下墓地里的"注火，"就要用神圣武器。这应该可以制服苏醒的骸骨。',
        location_en: 'Firelink Shrine',
        location_zh: '传火祭祀场',
      },
      {
        npcName_en: 'Domhnall of Zena',
        npcName_zh: '德纳尔',
        dialogue_en: "Hmm... well, since you're a good customer, I'll tell you. The ghosts of New Londo are under a curse and generally cannot be hurt. To hurt them, you need special weapons... or a cursed body. If you want to get cursed quickly, you'd normally go to the Depths and find the basilisks... but I wouldn't recommend it.",
        dialogue_zh: '嗯……算了，看在和你应该会有笔不错的交易份上……我就告诉你吧。小隆德的亡灵受到了诅咒，一般来说是伤不了他们的，想要伤到他们，就要特殊的武器……或受诅咒的身体。如果想早点受诅咒，一般是要去下水道找眼珠蜥蜴……但我是不建议啦。',
        fullDialogue_zh: '嗯……算了，看在和你应该会有笔不错的交易份上……我就告诉你吧。小隆德的亡灵受到了诅咒，一般来说是伤不了他们的，想要伤到他们，就要特殊的武器……或受诅咒的身体。如果想早点受诅咒，一般是要去下水道找眼珠蜥蜴……但我是不建议啦。',
        location_en: 'Firelink Shrine',
        location_zh: '传火祭祀场',
      },
      {
        ...
        dialogue_zh: '喔，你愿意呀！那真是太好了！既然如此，我就把这玩意儿交给你吧。这边真是个十分诡异的场所呀。时间停滞不动，不但一百多年前的传说就在眼前，而且非常不稳定，很多事物马上就会出现隔阂，你和我的世界也是，不知还能重合到什么时候呢。不过，使用这玩意儿的话……就可以超越世界间的隔阂来共同合作。召唤对方，使其以灵体状态前来，就能越过"隔阂"了。不过，会这么做的并不会只有我们就是……我是太阳战士所以召唤记号也是特制的，闪耀着光芒，我想看起来应该非常显目吧。哇哈哈哈哈！',
        fullDialogue_zh: '喔，你愿意呀！那真是太好了！既然如此，我就把这玩意儿交给你吧。这边真是个十分诡异的场所呀。时间停滞不动，不但一百多年前的传说就在眼前，而且非常不稳定，很多事物马上就会出现隔阂，你和我的世界也是，不知还能重合到什么时候呢。不过，使用这玩意儿的话……就可以超越世界间的隔阂来共同合作。召唤对方，使其以灵体状态前来，就能越过"隔阂"了。不过，会这么做的并不会只有我们就是……我是太阳战士所以召唤记号也是特制的，闪耀着光芒，我想看起来应该非常显目吧。哇哈哈哈哈！',
        location_en: 'Firelink Shrine',
        location_zh: '传火祭祀场',
      },
    ],
    ...
    npcDialogues: [
      {
        ...
        dialogue_zh: '喔，是你啊！你果然来啦！我的直觉果然很准！喔，你好！看起来你并不是游魂呢。我是亚斯特拉的索拉尔。你没猜错，我是太阳神的信徒。当我成为不死人后，便前来这个葛温大王诞生的地方找寻我自己的太阳！……你觉得我是个怪人吗？其实也真的是。别放在心上，大家听完之后都露出同样的表情啦。哇哈哈哈哈',
        fullDialogue_zh: '喔，是你啊！你果然来啦！我的直觉果然很准！喔，你好！看起来你并不是游魂呢。我是亚斯特拉的索拉尔。你没猜错，我是太阳神的信徒。当我成为不死人后，便前来这个葛温大王诞生的地方找寻我自己的太阳！……你觉得我是个怪人吗？其实也真的是。别放在心上，大家听完之后都露出同样的表情啦。哇哈哈哈哈',
      ...
      },
      {
        ...
        dialogue_zh: '唷，新来的。你在烦恼没办法进入不死教堂吗？拿这把钥匙去用吧。反正我已经用不到了。我是亚斯特拉的安德烈。我是个铁匠，要冶炼的话可以来找我。',
        fullDialogue_zh: '唷，新来的。你在烦恼没办法进入不死教堂吗？拿这把钥匙去用吧。反正我已经用不到了。我是亚斯特拉的安德烈。我是个铁匠，要冶炼的话可以来找我。',
      ...
      },
      {
        npcName_en: 'Andre of Astora',
        npcName_zh: '安德烈',
        dialogue_en: "Here is the old church. The Undead Parish you passed through was built after this place was abandoned. But that's not what I want to tell you. This place leads to two ancient forbidden areas: Sen's Fortress and Darkroot Garden. Neither are places normal people go. But then again, I've never seen a normal Undead. Hahaha.",
        dialogue_zh: '这里是古老教堂，你之前经过的不死教堂，是舍弃这里后才建的。不过那不是重点，我要说的是这里通往两个古老禁区，赛恩古城及黑森林庭院。赛恩古城及黑森林庭院，都不是什么正常人会去的地方……但我也没看过什么正常的不死人就是了。哈哈哈',
        fullDialogue_zh: '这里是古老教堂，你之前经过的不死教堂，是舍弃这里后才建的。不过那不是重点，我要说的是这里通往两个古老禁区，赛恩古城及黑森林庭院。赛恩古城及黑森林庭院，都不是什么正常人会去的地方……但我也没看过什么正常的不死人就是了。哈哈哈',
        location_en: 'Undead Parish',
        location_zh: '不死人教区',
      },
      {
        npcName_en: 'Andre of Astora',
        npcName_zh: '安德烈',
        dialogue_en: "Sen's Fortress was built by the ancient gods to test people. Legend says beyond it lies the gods' castle - the great Anor Londo. But most Undead can't even enter the fortress, like that onion knight. Hahaha.",
        dialogue_zh: '赛恩古城是古代神所建造，用来考验人的，传说从那往前走，有神的城堡──伟大的亚诺尔隆德。话说回来，大部分的不死人是连进到古城都办不到的，就像那个洋葱骑士一样。哈哈哈',
        fullDialogue_zh: '赛恩古城是古代神所建造，用来考验人的，传说从那往前走，有神的城堡──伟大的亚诺尔隆德。话说回来，大部分的不死人是连进到古城都办不到的，就像那个洋葱骑士一样。哈哈哈',
        location_en: 'Undead Parish',
        location_zh: '不死人教区',
      },
      {
      ...
      },
      {
        ...
        fullDialogue_zh: '如果你想要保持身为人的尊严，就向我告解吧。无论是赦罪或控诉……所有与罪相关的都是由我掌管。如果犯了什么罪，请你再来此处。任何的罪都是可以饶恕的。',
        location_en: 'Undead Parish',
        location_zh: '不死人教区',
      },
    ],
    ...
    items: [
      {
        ...
        description_zh: '过去骑士亚尔特留斯与深渊魔物订下契约的证据戒指。\n\n装备者能跟亚尔特留斯一样，漫步于深渊。',
    ...
    items: [
      {
        ...
        description_zh: '过去用来拴住罪犯的铁环。现已锈蚀得非常厉害，并隐约地带着血迹。\n\n将铁环当成戒指戴在手上的怪人，即便走在沼泽等恶劣地形，也不太容易被绊住脚。',
      ...
      },
      {
        ...
        description_zh: '形状样貌奇特，不太常见的人偶。\n\n据来源不明的传说所提，这是禁忌者才有的物品，这种人不容于世界，最后受到导引而到了冰冷的绘画世界中。',
    ...
    npcDialogues: [
      {
        ...
        fullDialogue_zh: '喔──原来敲响了苏醒之钟的人是你呀。我是世界之蛇，寻找王者的芙拉姆特，也是葛温大王的好友。敲响了苏醒之钟的不死人勇者呀，我要告诉你不死人所肩负的使命，那也是这个世界让你们这群不死人现身的理由。准备好要听了吗？很好，那就听我说吧。不死人勇者呀，你的使命……便是继承葛温大王。你得继承那位王者，让火再度燃起，赶走黑暗并消除不死人征象。为了达成这项使命，你必须先到王都亚诺尔隆德取得王器。话你也听完了，那么，我就打开赛恩古城的大门吧，那是前往亚诺尔隆德的必经之道。呜────！呜────！考验的路已经打开了，请面对你们这群不死人的命运吧。',
        location_en: 'Firelink Shrine',
        location_zh: '传火祭祀场',
      },
      {
      ...
      },
      {
        ...
        fullDialogue_zh: '你绝对不可以去亚诺尔隆德。不管是骑士王伦德尔，还是黑铁的塔尔卡斯，即便是罗根也不成。越是深入，你得到的绝望就越深。我很清楚，这百年来都这样。',
    ...
    npcDialogues: [
      {
        ...
        fullDialogue_zh: '你为我们做了这么多。我无法表达足够的感谢。......拿着这个，王器。将它放在传火祭祀场的祭坛上，通往初火之炉的道路就会打开。但首先，你必须收集四位伟大薪王的灵魂。',
      ...
      },
      {
        ...
        fullDialogue_zh: '前方即为葛温大王之墓，无论来者何人，均不许玷污该处。若汝无不敬之意，并为暗月之剑之忠实信徒，当在此伏地跪拜。汝若有决心立誓化为吾剑，以讨逆神贼敌，成为吾父葛温、吾姊葛维艾薇雅之影，吾当守护汝。速速离开此处，完成汝应尽之职责吧。',
        location_en: 'Anor Londo',
        location_zh: '亚诺尔隆德',
      },
      {
        ...
        fullDialogue_zh: '请你成为葛温大王后继者，传承世界之火吧。倘若失去了世界之火，所遗留下来的将只有冰冷的黑暗及恐惧而已。世界之蛇——寻找王者的芙拉姆特一定会从旁协助引导你的。自此之后，我就是你的守护者了。如果你有任何请求，我将竭尽一切能力来协助你。',
        location_en: 'Anor Londo',
        location_zh: '亚诺尔隆德',
      },
      {
        ...
        fullDialogue_zh: '从这里往前走，就可以去你要去的地方，葛温大王原本的城堡。如果你是真正的勇者，那么你应该可以在那得到天启。有需要就在这里休息吧。营火就是为此而设的嘛。说到这，你知道白龙希斯吗？在传说中，他是古龙的背叛者。他和葛温大王成为盟友，获得了公爵的称号和探究的自由，因而在巨大的书库里，成日研究自己所没有的不死鳞片。书库就位于这地方外面的左边山上。记住，千万不要靠近那里……守护者的营火比较特殊，彼此是连在一起的，火焰永远不会熄灭。',
        location_en: 'Anor Londo',
        location_zh: '亚诺尔隆德',
      },
      {
  ...
  // ==================== 第五阶段：击败翁斯坦与斯摩后 ====================
  {
    ...
    npcDialogues: [
      ...
      },
      {
        ...
        fullDialogue_zh: '很好。那么，身为寻找王者的人，我芙拉姆特要将下个使命告诉你这个未来的王。想要继承葛温大王，就一定要用伟大的灵魂来装满王器才行。然而，由于那位大王的灵魂既显眼又巨大……因此灵魂装得满王器的人，也是屈指可数。这些人包括了和葛温一样，拥有重要灵魂的王：墓王尼特、伊札里斯魔女，以及那些瓜分了葛温灵魂的小隆德诸王……还有大王过去的盟友──白龙希斯……若想装满王器，就要这些灵魂。……这样懂了吗？那我们就回去了，站好别乱动喔！',
        location_en: 'Firelink Shrine',
        location_zh: '传火祭祀场',
      },
    ],
    ...
    npcDialogues: [
      {
        ...
        fullDialogue_zh: '我是罗根，伟大的魔法师。......白龙希斯是背叛同类的叛徒。他背叛了古龙，加入了葛温王。现在他居住在公爵书斋，痴迷于不死。他的最初的结晶让他无敌。摧毁它，他就会变得脆弱。',
      ...
      },
      {
        ...
        fullDialogue_zh: '白龙希斯的不死秘密……伤口立刻就会痊愈，所以也不会受到致命伤，绝对不会死亡。那似乎是希斯背叛了古龙所取得的秘宝——原始结晶的效果。如果不先破坏原始结晶的话，就绝对无法伤到希斯分毫。而原始结晶便放在这座书库的中庭——结晶森林里头。',
        location_en: "Duke's Archives",
        location_zh: '公爵书斋',
      },
    ],
...

  {
    ...
    npcDialogues: [
      ...
      },
      {
        ...
        fullDialogue_zh: '你应该是遭到咒死的吧？吃了不少苦吧？不过，你可以放心了。解除你的诅咒这点事，我还办得到。不过，解咒原本是神的技艺，你得做好付出相对牺牲的觉悟。',
        location_en: 'New Londo Ruins',
        location_zh: '小隆德遗迹',
      },
      {
        ...
        fullDialogue_zh: '封印钥匙是在我的身上。不过在交给你之前，可以麻烦你帮我完成一件事吗？在屋顶上栖息着一只小隆德四王手下的吸魂鬼。可以麻烦你帮我打倒那家伙吗？小隆德四王便待在这座遗迹的最深处。你只要用这把钥匙解开封印……打开水门并向前走就可以了。那群家伙居住在叫作深渊的黑暗中，那是个寻常人所无法前往的场所。据说在很久以前，有个骑士亚尔特留斯曾走进深渊。如果找到他并借助他的力量，说不定就能成功地进入深渊。吸魂鬼是人和所有具灵魂生物的敌人。那群家伙就是生自小隆德，光是为了封印他们便导致了此地毁灭。',
        location_en: 'New Londo Ruins',
        location_zh: '小隆德遗迹',
      },
      {
        ...
        fullDialogue_zh: '不死人勇者呀，欢迎你的到来，我乃世界之蛇，平抚黑暗的卡斯。我将能引导你们这群不死人，告知你事实的真相。想知道你们人类与不死人的真相吗？你得要先证明自己值得我透露真相才行。动身前往亚诺尔隆德，并在那取得葛温的遗物——王器吧。我将打开赛恩古城的大门，那是前往亚诺尔隆德的必经之道。你们人类祖先得到黑暗灵魂后，便一直等着火熄灭。总有一天火会熄灭，世上所剩的将尽是黑暗。这么一来，便会进入你们人类的黑暗时代了。葛温大王却深深畏惧黑暗……他不断传火，命自己的孩子统率、束缚人，让你们人类忘记一切，浑噩过活，避免黑暗之王诞生。你得除掉违背天理传火、已摇摇欲坠的葛温大王，并成为第四位王，让黑暗的时代降临。你得搜集墓王尼特、伊札里斯魔女，还有那个背叛者——白龙希斯，这些人的灵魂，献到王器中。事不宜迟，赶紧迈步向前，除去那已摇摇欲坠的葛温吧。真正的黑暗便将遍布整个世界。',
  ...
  // ==================== DLC区域 ====================
  {
    ...
    items: [
      {
        ...
        description_zh: '破裂石头的项链，其中一半。\n\n颈绳用的藤蔓也许是乌拉席露的作工。虽然物品本身十分古老，但依然能感受到石头散发出的强大魔力。',
    ...
    npcDialogues: [
      ...
      },
      {
        ...
        fullDialogue_zh: '被黑色大手抓住，来到了过去……在这不熟悉的时代，多少会有不便，就让我们彼此互助吧。你碰上骑士亚尔特留斯了吗？就是原本时代里，那个传说中狩猎深渊的英雄啊。你打倒那个骑士亚尔特留斯啦？虽说被深渊给侵蚀，不过竟然能打倒那位英雄……深渊那档子事情，本来就是乌拉席露自作自受。被那匹暴牙大蛇骗去挖坟，侮辱先人遗骸——简直就是不要脸的愚蠢行为。你大可以袖手旁观，不是吗？旅行一路上，记得小心一点啊……',
      ...
      },
      {
        ...
        fullDialogue_zh: '我的故乡是古老魔法之地——乌拉席露。那些魔法知识，我想说不定可以帮助恩人您……如果有需要，请到记号处召唤我。乌拉席露的魔法和这个时代的魔法似乎有些不同。乌拉席露的魔法比较平易近人……而您这个时代的魔法看起来比较认真坚持，给人拒人千里于外的感觉。那位有名的骑士亚尔特留斯大人救了我。',
        location_en: 'Oolacile',
        location_zh: '乌拉席露',
      },
      {
        ...
        fullDialogue_zh: '再往前走，你大概也会了解：乌拉席露正逐渐被古代人形怪物酝酿的深渊所吞噬。骑士亚尔特留斯前往阻止，但英雄仍难抵抗黑暗，早晚还是会被深渊吞噬、被黑暗侵蚀吧。也许要阻止深渊已经是不可能的事情，但我还是希望能力挽狂澜，至少救出幽暗公主也好。他和你不一样，非常邪恶……或许他还停留在这个时代，是穿着黑色大衣、戴黑色帽子的男子，请千万小心……',
        location_en: 'Oolacile',
        location_zh: '乌拉席露',
      },
      {
        ...
        fullDialogue_zh: '那家伙叫做喀拉弥特，连昔日的亚诺尔隆德都故意视而不见的恐怖黑龙。你一介人类想要前往挑战……也太不自量力了。你对亚尔特留斯又有恩，就让你看看，我戈夫怎么猎龙吧。看到没，打个正着。那家伙再强，暂时是飞不起来了。剩下就要看你的功夫如何了。向龙挑战是骑士的荣耀。那侵蚀了吾友亚尔特留斯的深渊黑暗，现在正要吞噬这乌拉席露整个国度……看来，灭亡已难以避免。你若要像吾友一般，想要阻止这股黑暗，就去讨伐深渊之主，马努斯吧。黑暗由马努斯而生，这个国家的灭亡，或许可以避免更大的覆灭局面。光明将会消失，仅仅留下黑暗，就算是英雄也不能够阻止。如果想在这附近晃荡，当心那头黑龙。那家伙就算是你也是吃不消。你曾经打败过亚尔特留斯，那么你要当心一位名叫基亚蓝的女子。那女子很可能对亚尔特留斯怀抱着特别的情感。既已无龙，对我来说的确是无用之物。虽不敢说人类之身能否拉开此弓……我就把它交给你了。',
        location_en: 'Oolacile',
        location_zh: '乌拉席露',
      },
    ],
    ...
    npcDialogues: [
      {
        ...
        dialogue_en: "You have done well. You have collected the souls of the four great lords. Now, place them in the Lordvessel, and the path to the Kiln of the First Flame will open. There, Gwyn, the Lord of Cinder, awaits. You must succeed him, or the Age of Fire will end.",
        dialogue_zh: '你做得很好。你已经收集了四位伟大薪王的灵魂。现在，将它们放入王器，通往初火之炉的道路就会打开。在那里，薪王葛温在等待着你。你必须继承他，否则火焰时代将会结束。',
        fullDialogue_zh: '你做得很好。你已经收集了四位伟大薪王的灵魂。现在，将它们放入王器，通往初火之炉的道路就会打开。在那里，薪王葛温在等待着你。你必须继承他，否则火焰时代将会结束。',
        location_en: 'Firelink Shrine',
        location_zh: '传火祭祀场',
      },
      {
        ...
        fullDialogue_zh: '王器终于装满了灵魂......你无疑是葛温的后继者，也就是新的大王了......寻找王者的职责也要在此告一段落了......能够遇到你这小子还真令我开心呢，我终究是很喜欢人的呀。',
        location_en: 'Firelink Shrine',
        location_zh: '传火祭祀场',
      },
    ],
