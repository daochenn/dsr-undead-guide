...
console.log('All weapons with +10 upgrade (lower nibble = 10 or 0x0A):\n');
...
for (let i = 0; i < 3000; i++) {
  ...
  if (lowerNibble === 10) {
    ...
    console.log(`  Byte 0: 0x${byte0.toString(16).toUpperCase().padStart(2, '0')} (${INFUSION_NAMES[upperNibble]} +${lowerNibble})`);
...
console.log(`Total +10 weapons found: ${found}`);
