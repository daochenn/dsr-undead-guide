...
const SLOT_SIZE = 16; // Один слот = 16 байт = один предмет
const MAX_SLOTS = 3000;

// Структура слота (16 байт):
// Offset 0x00: Item ID (4 bytes, little-endian uint32)
// Offset 0x04: Quantity (4 bytes, little-endian uint32)
// Offset 0x08: Index (2 bytes, little-endian uint16)
// Offset 0x0A: ??? (2 bytes)
// Offset 0x0C: Durability (2 bytes, little-endian uint16)
// Offset 0x0E: Type? (2 bytes)
