...
console.log('Old Wolf Curved Sword in old save:');
...
for (let i = 0; i < 3000; i++) {
  ...
  if (itemId >= 0x00610BC0 && itemId <= 0x00610BCF) {
    ...
    console.log('  Byte 0: 0x' + byte0.toString(16).toUpperCase().padStart(2, '0') + ' (' + byte0.toString(2).padStart(8, '0') + ')');
    console.log('  Difference from base 0xC0: ' + (byte0 - 0xC0));
  }
}
